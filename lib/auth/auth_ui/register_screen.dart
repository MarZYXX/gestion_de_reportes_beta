...
class _RegisterPageState extends State<RegisterPage> {
                            ...
                            child: Form(
                              ...
                              child: Column(
                                children: [
                                  ...
                                  _buildTextField(_apellidoPaternoController, "Apellido Paterno", Icons.person),
                                  const SizedBox(height: 15),
                                  _buildTextField(_apellidoMaternoController, "Apellido Materno", Icons.person),
                                  const SizedBox(height: 15),
                                    ...
                                    child: Row(
                                      children: [
                                        ...
                                        Expanded(
                                          child: Text(
                                            _selectedRole == 'admin'
                                                ? 'Los administradores pueden gestionar reportes y modificar severidades.'
                                                : 'Los usuarios pueden crear reportes y corroborar incidentes.',
                                            style: TextStyle(
                                              fontSize: 12,
  ...
  Future<void> _handleRegister(BuildContext context, AuthViewModel viewModel) async {
    ...
    if (success) {
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text("¡Registro exitoso! Ahora inicia sesión como ${_selectedRole == 'admin' ? 'Administrador' : 'Usuario'}"),
  ...
  Widget _buildTextField(
    ...
    return TextFormField(
      ...
      validator: (value) {
        if (value == null || value.isEmpty) return "Ingrese $hint";
        if (hint == "Correo" && !value.contains('@')) return "Correo inválido";
        if ((hint == "Contraseña" || hint == "Confirmar Contraseña") && value.length < 6) {
